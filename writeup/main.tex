...
With $\lambda=0.1 s^-1$ and $\mu=0.001 s^-1$ we were easily able to run 100,000 nodes plus 100 known root nodes on a single core netbook. 

!!! series of experiments 10,1 1000,10 100000,100. test perceived network size \cite{arrg} and randomness
